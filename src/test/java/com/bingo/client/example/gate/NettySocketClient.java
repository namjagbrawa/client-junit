...
public class NettySocketClient {
    private final static Logger logger = LoggerFactory.getLogger(NettySocketClient.class);
    ...
    public NettySocketClient(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }
            ...
            bootstrap.group(workGroup)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            p.addLast(new SocketClientHandler(NettySocketClient.this));
                        }
                    });
            doConnect();
        } catch (Exception e) {
